...
# tn = read.csv("./dataset/tamilnadu.csv") 
...
# up = read.csv("./dataset/uttarpradesh.csv") 
...
# bihar = read.csv("./dataset/bihar.csv") 
...
# kerala = read.csv./dataset/kerala.csv") 
...
# andhra = read.csv("./dataset/andhrapradesh.csv") 
...
# arunachal = read.csv("./dataset/arunachal.csv") 
...
# assam = read.csv("./dataset/assam.csv") 
...
# chattisgarh = read.csv("./dataset/chattisgarh.csv") 
...
# gujarat = read.csv("./dataset/gujarat.csv") 
...
# haryana = read.csv("./dataset/haryana.csv") 
...
# himachal = read.csv("./dataset/himachalpradesh.csv") 
...
# jk = read.csv("./dataset/jammukashmir.csv") 
...
# jharkhand = read.csv("./dataset/jharkhand.csv") 
...
# karnataka = read.csv("./dataset/karnataka.csv") 
...
# mp = read.csv./dataset/madhyapradesh.csv") 
...
# maharashtra = read.csv("./dataset/maharashtra.csv") 
...
# odisha = read.csv("./dataset/odisha.csv") 
...
# punjab = read.csv("./dataset/punjab.csv") 
...
# rajasthan = read.csv("./dataset/rajasthan.csv") 
...
# ## 20. ----------------------------------------------------------------------------------------
# # Read the Uttarakhand literacy related data 
# uttarakhand = read.csv("./dataset/uttarakhand.csv") 
...
# westbengal = read.csv("./dataset/westbengal.csv") 
